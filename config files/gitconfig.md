...
The fixup alias was found on [30 seconds of code: Create a fixup commit in Git](https://www.30secondsofcode.org/git/s/create-fixup-commit/) and then ChatGPT was used to rewrite it to PowerShell
